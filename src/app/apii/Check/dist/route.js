        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ message: 'Order placed successfully!', order: data }, { status: 200 })];
                case 2:
                    error_1 = _a.sent();
                    // Handle any errors that occur during the order process
                    return [2 /*return*/, server_1.NextResponse.json({ message: 'Something went wrong with your order.', error: error_1.message }, { status: 500 })];
